...
#: The all-or-nothing hypothetical announcement threshold for `1.0.0-beta.6`. No feature or RFC
...
def render(reseed=False):
    ...
    beta_met = 0
    lines.append("## Hypothetical announcement readiness for `1.0.0-beta.6`")
    lines.append("")
    lines.append("| # | Predicate | State | Waiting on |")
    lines.append("|---|---|---|---|")
