...
<a href="CHANGELOG.md"><img alt="release: 1.0.0-rc.6" src="https://img.shields.io/static/v1?label=release&message=1.0.0-rc.6&color=blue"></a>
...
> **Status: <!-- BEGIN generated:workspace-version -->1.0.0-rc.6<!-- END generated:workspace-version -->.** This is the current public prerelease. `main` can move ahead of
...
The <!-- BEGIN generated:release-tag -->v1.0.0-rc.6<!-- END generated:release-tag --> prerelease needs
...
```toml
[dependencies]
sipx-call = "=1.0.0-rc.6"
sipx-sip = "=1.0.0-rc.6"
sipx-transport = "=1.0.0-rc.6"
