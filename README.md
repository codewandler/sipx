...
[![RFCs tracked](https://img.shields.io/badge/RFCs%20tracked-64-blue)](docs/compliance.md)
...
**[→ What sipx supports, RFC by RFC](docs/compliance.md).** 64 RFCs, each marked implemented,
