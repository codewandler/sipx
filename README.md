...
[![RFCs tracked](https://img.shields.io/badge/RFCs%20tracked-65-blue)](docs/compliance.md)
...
**[→ What sipx supports, RFC by RFC](docs/compliance.md).** 65 RFCs, each marked implemented,
