...
<a href="CHANGELOG.md"><img alt="release: 1.0.0-beta.2" src="https://img.shields.io/static/v1?label=release&message=1.0.0-beta.2&color=blue"></a>
...
> **Status: <!-- BEGIN generated:workspace-version -->1.0.0-beta.2<!-- END generated:workspace-version -->.** This is the current public-beta release. `main` can move ahead of
...
The <!-- BEGIN generated:release-tag -->v1.0.0-beta.2<!-- END generated:release-tag --> beta release needs
...
```toml
[dependencies]
sipx-call = "=1.0.0-beta.2"
sipx-transport = "=1.0.0-beta.2"
