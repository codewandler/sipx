...
[![RFCs tracked](https://img.shields.io/badge/RFCs%20tracked-69-blue)](docs/compliance.md)
...
**[→ What sipx supports, RFC by RFC](docs/compliance.md).** 69 RFCs, each marked implemented,
