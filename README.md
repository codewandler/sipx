...
[![RFCs tracked](https://img.shields.io/badge/RFCs%20tracked-68-blue)](docs/compliance.md)
...
**[→ What sipx supports, RFC by RFC](docs/compliance.md).** 68 RFCs, each marked implemented,
