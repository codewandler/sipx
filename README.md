...
<a href="CHANGELOG.md"><img alt="release: 1.0.0-alpha.4" src="https://img.shields.io/static/v1?label=release&message=1.0.0-alpha.4&color=blue"></a>
...
> **Status: <!-- BEGIN generated:workspace-version -->1.0.0-alpha.4<!-- END generated:workspace-version -->.** The public site documents `main`, which can move ahead of the latest
...
The <!-- BEGIN generated:release-tag -->v1.0.0-alpha.4<!-- END generated:release-tag --> release needs
Rust <!-- BEGIN generated:msrv -->1.88<!-- END generated:msrv --> or newer:

```sh
cargo install --locked --git https://github.com/codewandler/sipx --tag v1.0.0-alpha.4 sipx-cli
sipx version
```
...
```toml
[dependencies]
sipx-call = { git = "https://github.com/codewandler/sipx", tag = "v1.0.0-alpha.4" }
sipx-transport = { git = "https://github.com/codewandler/sipx", tag = "v1.0.0-alpha.4" }
...
The compliance registry currently tracks <!-- BEGIN generated:rfc-count -->70<!-- END generated:rfc-count --> RFCs; its public table is generated rather than copied by hand.
