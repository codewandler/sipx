...
## Now (in progress)
- [X-95 — Replay the unpublished beta.1 candidate under one-purpose authority](X-95-replay-the-unpublished-beta1-candidate.md) · Build · hard-bound historical completion after beta.2; beta.1 remains superseded and neither tag moves
