...
[maturity report](../maturity.md)'s **7 of 7 alpha-integrity predicates**. The beta.3 table is
currently **3 of 5** because `A-14` itself remains open until registry distribution and the final
public surfaces are verified. Those are all-or-nothing predicate counts, not weighted maturity
scores and not authorization for broader publicity.
