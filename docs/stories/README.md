...
The current published prerelease is **`1.0.0-beta.5`, not stable 1.0**. `A-35` is cutting the
integrated post-beta.5 tree as the new immutable `1.0.0-beta.6` candidate; announcement predicate 6
stays open until exact registry, CLI, Pages and GitHub release evidence agrees. The retained load
evidence covers the current endpoint direction only, and planned browser/media/application work is
not a runtime claim. The alpha-integrity table remains **7 of 7**.
...
## Now (in progress)
- [A-35 — Publish and verify 1.0.0-beta.6](A-35-publish-and-verify-beta6.md) · Application · next immutable beta from integrated main · exact registry, CLI, Pages and prerelease evidence
