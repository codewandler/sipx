...
The selected post-beta.4 implementation wave is **M13 — Endpoint-complete**: ten stories across
`stack-comparison`, `event-reachability`, `dialog-extensions`, `live-endpoint-policy`,
`test-surfaces` and `registration-observation`, queryable as `parity-wave-1`. S-42 is in progress;
the ready frontier is X-97, S-35, S-37, S-40, X-75 and T-31, while dependent stories remain backlog
until those contracts land. M14 holds the bounded
